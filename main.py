...
quake = Spell("Quake", 40, 1500, "black")
...
enemy1 = Person("Imp  :", 1500, 130, 700, 325, imp_spells, [])
enemy2 = Person("Magus:", 18000, 120, 560, 25, magus_spells, [])
enemy3 = Person("Imp  :", 1500, 130, 700, 325, imp_spells, [])
